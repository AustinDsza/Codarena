...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Description
    ref={ref}
    className={cn("text-sm text-foreground/80 font-medium leading-relaxed", className)}
    {...props}
  />
))
